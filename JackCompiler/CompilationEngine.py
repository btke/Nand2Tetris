            ...
            if Token == "=":
             ...
             #           self.VMWriter.writeComment("</letStatement>")
                        ...
                        if isArray == False:
                            ...
                            #Pop value of expression 2 to a temporary location
                            self.VMWriter.writePop("temp", 0)

                            #Pop address of array segment to 'That'
                            self.VMWriter.writePop("pointer", 1)
                            
                            #Push value of expression 2 back to stack
                            self.VMWriter.writePush("temp", 0)

                            #Push value to array segment
      ...
      #  self.VMWriter.writeComment("<term>")
        ...
        #varName[] (array) or someMethod() or someClass.someMethod() or 'x (symbol)'
            ...
            if LookAheadToken == '[':
                ...
                #Add expression value to array base address
                self.VMWriter.WriteArithmetic("+")

                #Save address to 'that'
                self.VMWriter.writePop("pointer", 1)

                #Push value to array to stack
